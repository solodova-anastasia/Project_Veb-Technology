<!-- https://www.youtube.com/watch?v=8EByZ4DgNs0 -->
...
$works = [
    ...
    "dateEnd" => "Январь 2015",
    "description" => "Тут описание работы тестироващиком.",
    ],
    [
    "name" >= "Главбух в Газпроме",
    "dateStart" => "Январь 2000",
    "dateEnd" => "Январь 2010",
    "description" => "Тут описание работы главбухом.",
    ],
];
?>
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $works[0]['name']; ?></b></h5>
